...
import { ADD_DICT } from "../../common/Graphql/mutation";
import { GET_ALL_WORDS_ID_NOTRANS } from "../../common/Graphql/query";
import WordsSelector from "./WordsSelector";

interface Props {}

export default function AddDict({}: Props): ReactElement {
